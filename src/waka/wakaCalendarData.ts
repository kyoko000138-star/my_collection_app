...
export const decemberThirdTen: WakaEntry[] = [
  ...
  },
  {
    ...
    date: {
      ...
      lunarLabel: '음력 11월 초',
      seasonalLabel: '바위도 나뭇잎도 모두 하얗게 덮인 날',
    },
    tags: ['12월', '겨울', '눈', '바위', '풍경', 'calm', '순백'],
    content: {
      original: {
        right: '白雪の\n所きらずも\n降る今日は',
        left: '岩も木の葉も\nなかりけり',
        hiragana: 'しらゆきの ところきらずも ふるきょうは いわもこのはも なかりけり',
      },
      info: {
        author: '紀貫之 키노 쓰라유키',
        source: '古今和歌集 冬歌 고금와카집 겨울가',
      ...
      translations: {
        modernJapanese: '白雪が場所を選ばずに降り続いている今日は、岩も木の葉も区別がなくなり、すべてが真っ白になってしまったことだ。',
        korean: '흰 눈이 장소를 가리지 않고 펑펑 내리는 오늘은, 바위도 나뭇잎도 모두 사라지고 온 세상이 하얗게 되었구나.',
      },
      commentary: '눈이 세상을 덮어 모든 사물의 경계를 지워버린 풍경을 노래했다. 울퉁불퉁한 바위도, 색색의 나뭇잎도 모두 순백색 하나로 통일된 모습에서 겨울 눈의 압도적인 포용력과 정갈한 아름다움이 느껴진다.',
    },
  },
  {
    id: 'december-24',
