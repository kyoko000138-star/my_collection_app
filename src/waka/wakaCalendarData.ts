...
export const wakaCalendarData: WakaEntry[] = [
  {
    ...
    content: {
      ...
      translations: {
        modernJapanese:
          '山里という所はいつの季節も寂しいが、冬になるとその寂しさはいっそう深く感じられる。人の訪れも絶え、草も枯れてしまうと思うからである。',
        korean:
          '산골 마을은 언제나 쓸쓸하지만\n겨울이 되면 그 쓸쓸함이 더욱 깊어지네\n찾아오는 사람도 끊기고 풀마저 말라 버린다고 생각하니',
      },
      commentary:
  ...
  },
  {
    ...
    content: {
      ...
      translations: {
        modernJapanese:
          '夕方になると袖のあたりまで寒さがしみてくる。吉野の山には今まさに雪が降っているのだろうと感じられる。',
        korean:
          '저녁이 되니 옷소매까지 추위가 스며드네\n아름다운 미요시노의 그 요시노 산에는\n눈이 내리고 있을 법하구나',
      },
      commentary:
  ...
  },
  {
    ...
    content: {
      ...
      translations: {
        modernJapanese:
          '吉野の山には白い雪が積もっているらしい。そのため古い都の里でも寒さがいよいよつのってきたと感じられる。',
        korean:
          '미요시노 산엔 흰 눈이 쌓였나 보네\n옛 도읍이던 이 고향도\n추위가 점점 더 깊어지는구나',
      },
      commentary:
  ...
  },
  {
    ...
    content: {
      ...
      translations: {
        modernJapanese:
          '今からはこのまま降り続いてほしいものだ。わが家の庭のすすきを押し伏せて降り積もる白い雪よと感じている。',
        korean:
  ...
  },
  {
    ...
    content: {
      ...
      translations: {
        modernJapanese:
          '冬ごもりの時季で思いもかけなかったが、木々の間から眺めると花かと思うほどに雪が降っていることだと歌っている。',
        korean:
          '겨울을 나느라 틀어박혀 있는데\n뜻밖에도 나무 사이로 보이는 것이\n꽃인 듯 보일 만큼 눈이 내려 쌓였네',
      },
      commentary:
  ...
  },
  {
    ...
    content: {
      ...
      translations: {
        modernJapanese:
          '雪が降ると、冬ごもりしている草や木にも春には見ることのない白い花が咲いたように見えるのだと歌っている。',
        korean:
          '눈이 내리니 겨울잠 든 풀도 나무도\n봄에는 볼 수 없는\n새하얀 꽃을 피운 듯하구나',
      },
      commentary:
  ...
  },
  {
    ...
    content: {
      ...
      translations: {
        modernJapanese:
          '冬であるのに空から花が散りこぼれてくる。そのように見えるのは、雲の向こう側ではもう春になっているのだろうかと感じている。',
        korean:
          '겨울인데도 하늘에서 꽃이 흩날리듯 떨어지는구나\n구름 너머 저쪽은 어쩌면\n벌써 봄이 된 것일까',
      },
      commentary:
  ...
  },
  {
    ...
    content: {
      ...
      translations: {
        modernJapanese:
          '降りしきる雪は、片端から消えているらしい。山中の急な瀬を流れる川の音がいっそう高くなって聞こえてくるからだと考えている。',
        korean:
          '내리는 눈은 금세 사라지고 있는 모양이네\n산속 급류의 여울물 소리가\n한층 더 요란하게 들리는 것을 보면',
      },
      commentary:
  ...
  },
  {
    ...
    content: {
      ...
      translations: {
        modernJapanese:
          '空がほのかに明るくなる明け方、有明の月の光かと思うほどに、吉野の里には白い雪が降り積もっているのだと歌っている。',
        korean:
  ...
  },
  {
    ...
    content: {
      ...
      translations: {
        modernJapanese:
          '大きな空にかかる月の光があまりにも澄みきっているので、その光を映していた水が何より先に凍りついてしまったのだと歌っている。',
        korean:
          '넓은 하늘의 달빛이 너무나도 맑기에\n그 모습을 비추던 물이\n가장 먼저 얼어붙었구나',
      },
      commentary:
