...
export const januaryThirdTen: WakaEntry[] = [
  ...
  },
  {
    ...
    date: {
      ...
      lunarLabel: '음력 12월 말',
      seasonalLabel: '새벽 서리가 내려앉은 강 다리',
    },
    tags: ['1월', '겨울', '새벽', '서리', '다리', 'calm', '우지'],
    content: {
      original: {
        right: '朝まだき\n宇治の川霧\nたえだえに',
        left: 'あらはれわたる\n瀬々の網代木',
        hiragana: 'あさまだき うじのかわぎり たえだえに あらはれわたる せぜのあじろぎ',
      },
      info: {
        author: '坂上是則 사카노우에노 코레노리',
        source: '百人一首 백인일수',
      ...
      translations: {
        modernJapanese: '夜が明けきらないころ、宇治川の川霧がとぎれとぎれに晴れていくにつれて、川瀬に立てられた網代木が次々と現れてくることだ。',
        korean: '아직 동이 트지 않은 새벽, 우지강의 안개가 듬성듬성 걷혀감에 따라 여울마다 박아놓은 그물 말뚝들이 차례차례 드러나는구나.',
      },
      commentary: '겨울 새벽의 정적과 서서히 밝아오는 아침의 풍경을 한 폭의 그림처럼 묘사했다. 자욱한 안개 사이로 인공물인 말뚝이 드러나는 모습에서 겨울 강변의 쓸쓸하고도 서정적인 분위기가 느껴진다.',
    },
  },
  {
    id: 'january-29',
